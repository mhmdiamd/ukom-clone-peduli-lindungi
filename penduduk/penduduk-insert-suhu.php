      ...
      <div class="col pe-3">
        <div class="row" style="height:100%">
          <div class="container" style="height:100%">
            ...
            <div class="col-12 col-content mt-3 d-flex align-items-center justify-content-center" style="height:100%;">
              <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="card p-4" style="width:20rem">
                        <div class="card-text text-center">
                            <h1><i class="fa-solid fa-hotel color-default"></i></h1>
                            <span>Location</span>
                            <h4>SMK AL AMANAH</h4>
                        </div>  
                                
            
                        <form action="penduduk-insert.php" method="POST">
                            <label for="suhu-penduduk">Suhu</label>
                            <input type="number" step="0.01" class="form-control mb-2" name="suhu" placholder="Masukan Suhu">
                            <input type="submit" class="btn w-100 rounded-pill bg-default text-light" value="Kirim">
                        </form>
